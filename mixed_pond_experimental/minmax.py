...
def calculate_phi_sn(day_argue):
    ...
    wind_speed = float(daily_data['wind_speed_2m'])
    ...
    phi_s = float(daily_data['SRAD_24'])  #Kj/m2/hr
...
def calculate_phi_at(day_argue):
    T_ak = observedtemp[(observedtemp['day']== day_argue)]
    T_ak = float(T_ak['min_air_temp_khu']) +273.15
...
def calculate_phi_e(T_wk,day_argue):
    ...
    T_ak = observedtemp[(observedtemp['day']== day_argue)]
    T_ac = float(T_ak['min_air_temp_khu']) 
    T_ak = T_ac +273.15
...
def calculate_phi_at(day_argue):
    T_ak = observedtemp[(observedtemp['day']== day_argue)]
    T_ak = float(T_ak['max_air_temp_khu']) + 273.15
    e = (0.398 * (10 ** (-5)))*(T_ak ** (2.148))
...
def calculate_phi_e(T_wk,day_argue):
    ...
    T_ak = observedtemp[(observedtemp['day']== day_argue)]
    T_ac = float(T_ak['max_air_temp_khu']) 
    T_ak = T_ac +273.15
